...
OBJS = main.o game_utils.o game_state.o menu_system.o name_selection.o renderer.o audio_system.o loadobj.o blitobj.o movement.o initstorysplash.o wfont.o romdisk.o 
